...
import Hero from '@/components/service-2/Hero';
import MeetOurTeam from '@/components/service-2/MeetOurTeam';
import Clients from '@/components/service-1/Clients';
import Services from "@/components/service-2/WhyChoose"
import Service from '@/components/service-2/OurApproach';
import Integrations from '@/components/service-2/Industries';
import ScrollingAppsShowcase from '@/components/service-2/Technologies';
import CTA from '@/components/service-2/CTA';
