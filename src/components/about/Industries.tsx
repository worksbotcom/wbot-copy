                ...
                {industries.map((review) => (
                  <SwiperSlide key={review.id} className="swiper-slide">
                    ...
                    >
                      ...
                      {/* Icon */}
                      <figure className="relative inline-flex size-16 items-center justify-center rounded-full bg-white ring-4 ring-white/90 dark:ring-background-5">
                        {(() => {
                          const Icon = review.icon;
                          return (
                            <Icon className="size-8 text-secondary dark:text-accent" strokeWidth={1} />
                          );
                        })()}
                      </figure>
