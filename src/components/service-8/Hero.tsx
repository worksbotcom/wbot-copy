...
const stories: Story[] = [
  {
    id: 0,
    bgImage: '/images/workbot/home/card29.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'Rapid Prototyping & MVP Development',
    description:
      'Quickly build functional prototypes to validate ideas and gather user feedback.',
    impact:
      'Reduces validation time by 60–80% and cuts early-stage costs by 50%.'
  },
  {
    id: 1,
    bgImage: '/images/workbot/home/card30.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'Full-Stack Product Engineering',
    description:
      'Design, architect, and develop scalable digital or physical products end-to-end.',
    impact:
      'Speeds product delivery by 40–60% and improves scalability by 2×.'
  },
  {
    id: 2,
    bgImage: '/images/workbot/home/card31.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'Hardware & IoT Prototyping',
    description:
      'Create functional hardware models with embedded software and cloud connectivity.',
    impact:
      'Accelerates hardware testing by 3× and reduces rework by 70%.'
  },
  {
    id: 3,
    bgImage: '/images/workbot/home/card32.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'UX/UI Design & Usability Testing',
    description:
      'Develop intuitive designs and test prototypes with real users for product-market fit.',
    impact:
      'Increases user adoption by 40%+ and reduces redesign cycles by 50%.'
  },
];
            ...
            <div className="flex items-start gap-12 xl:gap-0 flex-col lg:flex-row justify-between pt-4 lg:pt-[120px] xl:pt-[42px] pb-[110px]">
              ...
              <div className="lg:max-w-[590px] xl:max-w-[629px] w-full space-y-5 lg:space-y-6 text-center md:text-left">
                <RevealAnimation delay={0.1}>
                   <span className="px-5 py-2 rounded-full text-sm font-medium tracking-wider bg-primary-50 text-primary-600 border border-primary-600">Product Engineering & Prototyping</span>
                </RevealAnimation>
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <RevealAnimation delay={0.3}>
                    <p>
                      At <strong>Worksbot</strong>, we offer <strong>product engineering and prototyping</strong> services that help businesses accelerate innovation and bring high-quality products to life. Whether developing early-stage prototypes, designing hardware–software systems, or building fully integrated digital products, our engineering teams ensure speed, precision, and scalability at every step.
                    </p>
                  </RevealAnimation>
                </div>
