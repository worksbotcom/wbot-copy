        ...
        <RevealAnimation delay={0.1}>
          <div className="relative xl:px-20 md:px-10 px-6 bg-secondary dark:bg-background-8 rounded-[20px] overflow-hidden">
            ...
            <CTAV1
              ...
              /* Your new text */
              ctaHeading="Ready to build your AI strategy and accelerate digital transformation?"
              description="Contact Us today to begin your AI consulting journey with Worksbot."
