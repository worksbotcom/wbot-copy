...
const stories: Story[] = [
  {
    id: 0,
    bgImage: '/images/workbot/home/1.png',
    bgColor: 'rgb(5,5,7)',
    title: 'AI Transformation Roadmap',
    description: 'Identify high-value AI opportunities and build a clear adoption plan.',
    impact: ' Up to 4× faster decision-making and 2× higher project success rates.'
  },
  {
    id: 1,
    bgImage: '/images/workbot/home/2.png',
    bgColor: 'rgb(5,5,7)',
    title: 'Intelligent Automation',
    description: 'Use AI to streamline workflows and reduce manual effort.',
    impact: ' Cuts operational work by 50–70% and reduces errors by 90%+.'
  },
  {
    id: 2,
    bgImage: '/images/workbot/home/card1.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'AI-Powered Customer Experience',
    description: 'Deliver personalized journeys and predictive insights.',
    impact: ' Boosts customer engagement by 40%+ and lifts conversions by 20–30%.'
  },
  {
    id: 3,
    bgImage: '/images/workbot/home/4.png',
    bgColor: 'rgb(5,5,7)',
    title: 'AI Governance & Compliance',
    description: 'Ensure AI is secure, ethical, and regulation-ready.',
    impact: 'Reduces compliance risk by 80% and increases trust & adoption by 2×.'
  },
];
            ...
            <div className="flex items-start gap-12 xl:gap-0 flex-col lg:flex-row justify-between pt-4 lg:pt-[120px] xl:pt-[42px] pb-[110px]">
              ...
              <div className="lg:max-w-[590px] xl:max-w-[629px] w-full space-y-5 lg:space-y-6 text-center md:text-left">
                <RevealAnimation delay={0.1}>
                  <span className="px-5 py-2 rounded-full text-sm font-medium tracking-wider bg-primary-50 text-primary-600 border border-primary-600">AI Consulting & Digital Strategy</span>
                </RevealAnimation>

                <div className="space-y-4 mt-3">
                  <RevealAnimation delay={0.2}>
                    <h1 className="text-[clamp(32px,4vw,64px)]  leading-[1.15] max-w-[900px] text-balance font-bold">
                      Transforming businesses with  <span className="whitespace-nowrap">intelligent innovation.</span>
                    </h1>
                  ...
                  <RevealAnimation delay={0.3}>
                    <p>
                      At <strong>Worksbot</strong>, we help organizations navigate the complexities of AI adoption with strategic consulting and tailored digital transformation roadmaps. Our experts work closely with your teams to identify opportunities, assess technical and operational readiness, and design scalable AI strategies that deliver long-term value.
                    </p>
                  </RevealAnimation>
                </div>
