        ...
        <RevealAnimation delay={0.1}>
          <div className="relative xl:px-20 md:px-10 px-6 bg-secondary dark:bg-background-8 rounded-[20px] overflow-hidden">
            ...
            <CTAV1
              ...
              /* Your new text */
              ctaHeading="Ready to turn your data into a strategic advantage?"
              description="Contact Us today to build your next data engineering and analytics solution with Worksbot."
