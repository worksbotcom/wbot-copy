...
const stories: Story[] = [
  {
    id: 0,
    bgImage: '/images/workbot/home/card21.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'Real-Time Data Pipelines & Integration',
    description:
      'Unify data from multiple sources into fast, reliable pipelines.',
    impact:
      'Improves data availability by 99% and reduces reporting delays by 80%.'
  },
  {
    id: 1,
    bgImage: '/images/workbot/home/card22.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'Data Warehousing & Single Source of Truth',
    description:
      'Build scalable data lakes/warehouses for consistent, trusted insights.',
    impact:
      'Boosts analytics accuracy by 90%+ and cuts data silos by 70%.'
  },
  {
    id: 2,
    bgImage: '/images/workbot/home/card23.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'Advanced Analytics & Predictive Insights',
    description:
      'Use machine learning and analytics to forecast trends and optimize decisions.',
    impact:
      'Increases forecasting accuracy by 50–70% and drives 2–3× faster decisions.'
  },
  {
    id: 3,
    bgImage: '/images/workbot/home/card24.jpg',
    bgColor: 'rgb(5,5,7)',
    title: 'BI Dashboards & KPI Automation',
    description:
      'Create interactive dashboards and automate business reporting.',
    impact:
      'Reduces manual analysis by 60–80% and improves executive visibility by 3×.'
  },
];
            ...
            <div className="flex items-start gap-12 xl:gap-0 flex-col lg:flex-row justify-between pt-4 lg:pt-[120px] xl:pt-[42px] pb-[110px]">
              ...
              <div className="lg:max-w-[590px] xl:max-w-[629px] w-full space-y-5 lg:space-y-6 text-center md:text-left">
                <RevealAnimation delay={0.1}>
                   <span className="px-5 py-2 rounded-full text-sm font-medium tracking-wider bg-primary-50 text-primary-600 border border-primary-600">Data Engineering & Analytics</span>
                </RevealAnimation>
                ...
                <div className="space-y-4 mt-6">
                  ...
                  <RevealAnimation delay={0.3}>
                    <p>
                      At <strong>Worksbot</strong>, we deliver <strong>data engineering and analytics</strong> solutions that empower businesses to unlock the full potential of their data. From building seamless data pipelines and enterprise data warehouses to developing advanced analytics and BI platforms, we help organizations make fast, informed, and data-driven decisions.
                    </p>
                  </RevealAnimation>
                </div>
                        ...
                        >
                          ...
                          >
                            <div className="absolute inset-0 bg-black/50 to-transparent p-6 sm:p-4 lg:p-6 flex flex-col justify-between text-white z-10">
                              <div>
                                {/* ✅ TITLE */}
                                <h1 className="text-3xl font-bold mb-3 text-white uppercase mt-10 md:mt-15 lg:mt-[60px]">
                                  {story.title}
                                </h1>
