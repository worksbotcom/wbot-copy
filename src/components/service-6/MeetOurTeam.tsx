      ...
      <div className="main-container">
        <div className="space-y-7 md:space-y-14">
          <h2 ref={titleRef} className="split-text-team-title text-center">
            Our teams specialize in designing scalable data architectures, real time processing systems, and predictive analytics models that turn raw data into valuable intelligence fueling digital transformation across industries.
          </h2>
