      ...
      <div className="main-container">
        <div className="space-y-7 md:space-y-14">
          <h2 ref={titleRef} className="split-text-team-title text-center">
             Our QA teams combine advanced automation tools, proven testing methodologies, and deep industry expertise to provide fast, accurate, and scalable testing solutions reducing defects, improving user experience, and accelerating time to market.
                  </h2>
