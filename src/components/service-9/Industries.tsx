...
const stackCards = [
  {
    icon: Laptop,
    title: 'Software & IT',
    description: 'Web applications, mobile apps, SaaS platforms, and enterprise software testing.',
  },
  {
    icon: Microchip,
    title: 'Semiconductor & Electronics',
    description: 'Chip testing, board-level validation, performance, and reliability engineering.',
  },
  {
    icon: CreditCard,
    title: 'Finance & Banking',
    description: 'Secure transaction testing, fraud prevention validation, and compliance checks.',
  },
  {
    icon: HeartPulse,
    title: 'Healthcare',
    description: 'Regulatory testing, HIPAA-compliant validation, and medical software QA.',
  },
  {
    icon: ShoppingCart,
    title: 'Retail & E-Commerce',
    description: 'Load testing, UX validation, checkout flows, and payment gateway testing.',
  },
  {
    icon: CarFront,
    title: 'Automobile & Manufacturing',
    description: 'Embedded software testing, hardware-in-loop validation, and reliability checks.',
  },
  {
    icon: Wifi,
    title: 'Telecom',
    description: 'Network performance testing, QoS validation, and telecom security testing.',
  },
  {
    icon: Truck,
    title: 'Logistics & Supply Chain',
    description: 'Workflow testing, end-to-end integration validation, and automation QA.',
  },
];
          ...
          <div className="w-full lg:flex-1 lg:sticky lg:top-28 lg:max-w-full max-w-[520px] lg:mx-0 mx-auto text-center lg:text-left">
            ...
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                Worksbot’s QA & Testing Services support businesses across.
              </p>
            </RevealAnimation>
          </div>
