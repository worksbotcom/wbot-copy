        ...
        <RevealAnimation delay={0.1}>
          <div className="relative xl:px-20 md:px-10 px-6 bg-secondary dark:bg-background-8 rounded-[20px] overflow-hidden">
            ...
            <CTAV1
              ...
              /* Your new text */
              ctaHeading="Ready to transform your operations with intelligent automation?"
              description="Contact Us today to start your RPA and workflow automation journey with Worksbot."
