...
const stackCards = [
  {
    icon: CarFront,
    title: 'Automobile & EV',
    description: 'ECU software, motor control systems, and battery management solutions.',
  },
  {
    icon: CircuitBoard,
    title: 'Semiconductor & Electronics',
    description: 'Board-level firmware, embedded chip programming, and hardware integration.',
  },
  {
    icon: Smartphone,
    title: 'Consumer Electronics',
    description: 'Smart home devices, wearables, audio systems, and embedded product firmware.',
  },
  {
    icon: HeartPulse,
    title: 'Healthcare & MedTech',
    description: 'Medical devices, embedded monitoring systems, and diagnostic platforms.',
  },
  {
    icon: Cog,
    title: 'Industrial Automation',
    description: 'Robotics, sensor interfaces, motor controllers, and industrial embedded systems.',
  },
  {
    icon: Radio,
    title: 'IoT & Smart Devices',
    description: 'Embedded sensors, connected gateways, and real-time edge computing platforms.',
  },
  {
    icon: Radar,
    title: 'Aerospace & Defense',
    description: 'Mission-critical software, real-time embedded systems, and secure control units.',
  },
];
          ...
          <div className="w-full lg:flex-1 lg:sticky lg:top-28 lg:max-w-full max-w-[520px] lg:mx-0 mx-auto text-center lg:text-left">
            ...
            <RevealAnimation delay={0.4}>
              <p className="mb-14 lg:max-w-[620px]">
                Worksbot’s Embedded Systems Development services support a wide range of industries.
              </p>
            </RevealAnimation>
          </div>
