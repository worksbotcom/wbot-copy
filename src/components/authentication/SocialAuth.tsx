...
const SocialAuth = () => {
  return (
    <div className="space-y-4">
      <button className="flex items-center justify-center gap-2 w-full border border-stroke-3 py-3 px-8 rounded-sm cursor-pointer dark:border-stroke-7 hover:bg-primary-500 group transition-colors duration-500 ease-in-out">
